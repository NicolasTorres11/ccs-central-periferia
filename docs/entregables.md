...
| --- | ----------------------------------------------------------------------------------------------- | -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | Diagrama de secuencia de cada flujo, despliegue y componentes de la solucion propuesta.         | Cubierto | `docs/sequence-diagrams.md` (5 flujos con imagenes renderizadas), `docs/deployment-diagram.md`, `docs/architecture.md`, `arquitectures/`                                                                                                             |
